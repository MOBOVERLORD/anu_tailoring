"""Frozen SQLAlchemy schema snapshot used only by baseline migration 20260826_0001.

Do not edit this file when application models change. Create a new Alembic
revision instead.
"""
...
class Base(DeclarativeBase):
    """Frozen metadata registry for the 2026-08-26 database baseline."""
